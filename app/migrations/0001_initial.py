# Generated by Django 4.1.2 on 2022-11-20 09:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postInfo', models.CharField(blank=True, choices=[('ND', 'Nhặt được'), ('TK', 'Tìm kiếm')], max_length=10, verbose_name='Kiểu tin tức')),
                ('typeItem', models.CharField(blank=True, choices=[('ID', 'Ví/Giấy tờ'), ('PET', 'Thú cưng'), ('PEOPLE', 'Người'), ('ED', 'Điện thoại/Tablet/Laptop'), ('KEY', 'Chìa khóa'), ('TRANSPORT', 'Xe máy/Ô tô'), ('OTHER', 'Đồ vật khác')], max_length=50, verbose_name='Phân loại đồ')),
